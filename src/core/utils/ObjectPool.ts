    ...
    public static pop(refKey:string, ...args:any[]):any {
        ...
        if(obj && refKey == "GLoader") {
            if(obj.x != 0 || obj.y != 0 || obj.alpha != 1 || obj.width != 0 || obj.height != 0) {
                ...
                obj.height = 0;
                obj.alpha = 1;
                //console.log("GLoader缓存池对象属性没有重置x:",obj.x,"y:",obj.y,"alpha:",obj.alpha,"width:",obj.width,"height:",obj.height);
            }
        }
        if(obj && refKey == "RpgMovieClip" && obj.alpha != 1) {
            obj.alpha = 1;
            obj.visible = true;
        }
        return obj;
