class ClothesFashionCache extends BaseFashionCache{
	...
	protected getListData():any[]{
		return ConfigManager.mgFashion.getFashionByType(1);
	}
	...
	public get modelId(): number{
		if(this.fashionData){
			return ConfigManager.client.getPlayerFashionId(this.fashionData.modelId,CacheManager.role.getBaseCareer());
		}
		return 0;
	}
